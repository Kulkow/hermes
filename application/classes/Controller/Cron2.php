...
class Controller_Cron2 extends Controller_Layout
{
    ...
    public function action_index()
	{
       ...
       */
       /*if(! ORM::factory('Role', array('name' => $alias))->loaded()){
          echo 'no';
          $r = ORM::factory('Role')->values(array('name' => $alias, 'description' => 'Ãğóïïà äëÿ ğåôåğàëîâ ñ áîëüùèì ïğîöåíòîì'));
          $r->save();
          print_r($r->as_array());
       }*/
       //
