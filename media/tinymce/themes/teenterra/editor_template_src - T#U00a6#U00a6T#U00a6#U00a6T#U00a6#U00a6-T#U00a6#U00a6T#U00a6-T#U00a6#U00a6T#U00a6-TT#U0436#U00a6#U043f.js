...
//				}, s);
//			}
			if (!s.theme_bar1) {				s = extend({					theme_bar1: 'bold,italic,underline,strikethrough,|',
					theme_bar2: ''				}, s);			}
...
//		},
		...
		renderUI : function(o) {
			...
			n = DOM.create('div', {id : ed.id + '_parent', 'class': 'mceEditor ' + ed.settings.skin + 'Skin' + (s.skin_variant ? ' ' + ed.settings.skin + 'Skin' + t._ufirst(s.skin_variant) : '')});
