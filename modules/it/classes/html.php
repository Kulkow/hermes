...
{	/**
	 * TODO : config for strip_tags_smart
	 */
	static protected $_strip_tags_config = array(
	    'allowable_tags' 	=> NULL,
		...
		'para_tags'			=> array(
			'p', 'td', 'th', 'li', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'div', 'form', 'title', 'pre',
		),
	);

	static public function strip_tags($value)
	{
		extract(HTML::$_strip_tags_config);
		return strip_tags_smart($value, $allowable_tags, $is_format_spaces, $pair_tags, $para_tags);	}
}
