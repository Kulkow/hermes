 ...
 */
class Kohana_Database_MsSQL_Result extends Database_Result {
	...
	{
		if ($this->offsetExists($offset) AND mssql_data_seek($this->_result, $offset))
		{
	...
	public function current()
	{
		...
		elseif (is_string($this->_as_object))
		{
			...
			return mssql_fetch_object($this->_result, $this->_as_object, $this->_object_params);
		}
		else
		{
